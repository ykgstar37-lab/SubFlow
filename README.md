...
[![iOS](https://img.shields.io/badge/iOS-App_Store_출시-34C759)](https://apps.apple.com/kr/app/id6806811998)
...
| | 기능 | 설명 |
|:--:|---|---|
| 📚 | **서비스 카탈로그** | 15개 카테고리 · **99종 서비스 · 198개 요금제** 내장. 없는 요금제는 직접 입력 |
...
서비스 카탈로그(99종/198요금제)는 서버 기동 시 lifespan 훅이 자동으로 시드한다.
...
| `services` / `service_plans` | 카탈로그 99종 / 요금제 198개 |
